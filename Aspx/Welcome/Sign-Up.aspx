...
<asp:Content ContentPlaceHolderID="Main_Content_Placeholder" Runat="Server">
    <p class="generic_title"><b>Enter your new account details</b></p>
    <br />
    <form runat="server" class="generic_form" id="addUserForm">
        ...
        <br />
        <br />
        <asp:Button id="submitButton" runat="server" Text="Submit" OnClick="signUpButtonClicked" />
    </form>
</asp:Content>
